package com.consolegames.rummikubGame.core;
...
public class Player {
    ...
    public ArrayList<String> listOfPlayedTiles = new ArrayList<>();

    public ArrayList<String> arrOfNext = new ArrayList<>();

    public boolean scanArray(String[][] x, int y, int z){
        return arrOfNext.contains(x[y][z]);
    }

    public void checkBoardStatus(String[][] array, String m, ArrayList<String> tiles, Field field, boolean fullMenu, int x){
    ...
    public void addPlayedTiles(int r, int c){
        String combo = r+" "+c;
        listOfPlayedTiles.add(combo);
    }

    public void removePlayedTiles(int r, int c){
        String combo = r+" "+c;
